!function() {
    ...
    function getISODaysInYear() {
        return Math.ceil((getISOFirstMondayOfYear.call(new Date(this.getFullYear() + 1, 0, 1)) - this.ISOFirstMondayOfYear()) / MS_DAY);
    }
    ...
    function getISOWeeksInYear() {
        return Math.round((getISOFirstMondayOfYear.call(new Date(this.getFullYear() + 1, 0, 1)) - this.ISOFirstMondayOfYear()) / MS_WEEK);
    }
    function adjust(o, v) {
